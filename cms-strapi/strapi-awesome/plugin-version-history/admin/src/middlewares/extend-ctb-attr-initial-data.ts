...
/**
 *
 * @see packages/plugins/i18n/admin/src/middlewares/extendCTBAttributeInitialData.ts
 */
export const extendCTBAttributeInitialDataMiddleware: () => Middleware<
  object,
...
> = () => {
  return ({ getState }) =>
    ...
    (action) => {
      ...
      if (
        action.type ===
          'ContentTypeBuilder/FormModal/SET_ATTRIBUTE_DATA_SCHEMA' &&
