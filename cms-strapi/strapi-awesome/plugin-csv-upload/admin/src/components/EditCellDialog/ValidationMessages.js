...
const ValidateIcon = ({ error }) => {
  ...
  return <span>{<Component style={style} />}</span>;
};
    ...
    <List>
      ...
      {attribute.type === 'email' && (
        <Message error={isEmailError}>
          <ValidateIcon error={isEmailError} />
          &nbsp;
          <ValidateText text={'Email address format'} />
        </Message>
      )}
      {typeof attribute.required !== 'undefined' && (
        <Message error={isRequiredError}>
          <ValidateIcon error={isRequiredError} />
          &nbsp;
          <ValidateText text={'required'} />
        </Message>
      )}
