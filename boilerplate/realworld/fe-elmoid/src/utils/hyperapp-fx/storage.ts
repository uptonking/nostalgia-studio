...
function storageArea(area): Storage {
...
/**
 * Describes an effect that will read the value of a key from Storage.
 * - By default the item is read from `localStorage`
 * - Values are converted from JSON, unless a custom converter is provided.
 *
 * @param {object} props
