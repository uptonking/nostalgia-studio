...
import { LogError } from './common/forms.js';
import { ArticleList, loadingArticles } from './common/articles.js';
import { FetchArticles } from './common/articles.js';
...
const ChangeFollow = (method) => (state) => [
  ...
  Http({
    url:
      API_ROOT +
      '/profiles/' +
      encodeURIComponent(state.profile.username) +
      '/follow',
...
const Tabs = ({ username, activeFeedType }) => html`
