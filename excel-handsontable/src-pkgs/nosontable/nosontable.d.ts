declare namespace _Handsontable {
  class Core {
    ...
    getPlugin<T extends keyof Handsontable.PluginsCollection>(
      pluginName: T,
    ): Handsontable.PluginsCollection[T];
    ...
    selectCells(
      coords:
        ...
        | Array<Handsontable.wot.CellRange>,
      scrollToCell?: boolean,
      changeListener?: boolean,
    ): boolean;
    selectColumns(
    ...
    setDataAtCell(
      changes: Array<[number, string | number, any]>,
      source?: string,
    ): void;
    setDataAtRowProp(
      row: number,
...
declare namespace Handsontable {
  ...
  namespace _editors {
    class Base {
      ...
      constructor(
        hotInstance: _Handsontable.Core,
        row: number,
        col: number,
        prop: string | number,
        TD: HTMLElement,
  ...
  namespace plugins {
    ...
    namespace FiltersPlugin {
      ...
      interface ConditionCollection {
        ...
        addCondition(
          column: number,
          conditionDefinition: ConditionId,
    ...
    interface ColumnSorting extends Base {
      ...
      isSorted(): boolean;
      setSortConfig(
        sortConfig?: columnSorting.Config | Array<columnSorting.Config>,
      ): void;
    ...
    interface CustomBorders extends Base {
      ...
      setBorders(
        selection: Range[] | Array<[number, number, number, number]>,
        borderObject: object,
      ): void;
      getBorders(
        selection: Range[] | Array<[number, number, number, number]>,
    ...
    interface Filters extends Base {
      ...
      addCondition(
        ...
        name: string,
        args: any[],
        operationId: FiltersPlugin.OperationType,
      ): void;
    ...
    namespace MergeCellsPlugin {
      interface AutofillCalculations {
        ...
        snapDragArea(
          ...
          foundMergedCells: MergeCellsPlugin.MergedCellCoords[],
        ): number[];
      ...
      interface SelectionCalculations {
        snapDelta(
          delta: object,
          selectionRange: wot.CellRange,
          mergedCell: MergeCellsPlugin.MergedCellCoords,
        ): void;
        getUpdatedSelectionRange(
          oldSelectionRange: wot.CellRange,
          delta: object,
        ): wot.CellRange;
      }
      ...
      interface MergedCellsCollection {
        ...
        get(
          row: number,
          column: number,
        ): MergeCellsPlugin.MergedCellCoords | boolean;
        getByRange(
          range: wot.CellRange | object,
        ): MergeCellsPlugin.MergedCellCoords | boolean;
        getWithinRange(
          range: wot.CellRange | object,
    ...
    interface MultipleSelectionHandles extends Base {
      ...
      getCurrentRangeCoords(
        selectedRange: wot.CellRange,
        currentTouch: wot.CellCoords,
  ...
  interface Hooks {
    ...
    afterChange?: (
      changes: [number, string | number, any, any][],
      source: string,
    ) => void;
    ...
    afterColumnSort?: (
      currentSortConfig: object[],
      destinationSortConfigs: object[],
    ) => void;
    ...
    afterDrawSelection?: (
      currentRow: number,
      currentColumn: number,
      cornersOfSelection: number[],
      layerLevel: number | void,
    ) => string | void;
    afterDropdownMenuDefaultOptions?: (predefinedItems: any[]) => void;
    afterDropdownMenuHide?: (
      instance: Handsontable.plugins.DropdownMenu,
    ) => void;
    ...
    afterMergeCells?: (
      cellRange: wot.CellRange,
      mergeParent: object,
      auto: boolean,
    ) => void;
    afterModifyTransformEnd?: (
      coords: wot.CellCoords,
  ...
  namespace I18n {
    ...
    interface Internationalization {
      ...
      registerLanguageDictionary: (
        languageCodeOrDictionary: LanguageDictionary | string,
  ...
  interface Helper {
    ...
    arrayEach(
      array: any[],
      iteratee: (value: any, index: number, array: any[]) => void,
    ): any[];
    arrayFilter(
      array: any[],
      predicate: (value: any, index: number, array: any[]) => void,
    ): any[];
    ...
    objectEach(
      object: object,
      iteratee: (value: any, key: any, object: object) => void,
    ): object;
  ...
  namespace multiColumnSorting {
    interface Settings {
      ...
      headerAction?: boolean;
      compareFunctionFactory?: (
        sortOrder: columnSorting.SortOrderType,
        columnMeta: GridSettings,
      ) => (value: any, nextValue: any) => -1 | 0 | 1;
    }
  }
