...
export function cellMethodLookupFactory(methodName, allowUndefined) {
  const isUndefinedAllowed =
    typeof allowUndefined === 'undefined' ? true : allowUndefined;
  ...
  return function cellMethodLookup(row, col) {
    return (function getMethodFromProperties(properties) {
      if (!properties) {
        ...
        hasOwnProperty(properties, methodName) &&
        properties[methodName] !== undefined
      ) {
