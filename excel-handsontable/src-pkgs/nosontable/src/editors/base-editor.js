...
BaseEditor.prototype.prepare = function (
  row,
  col,
  prop,
  td,
...
BaseEditor.prototype.finishEditing = function (
...
BaseEditor.prototype.checkEditorSection = function () {
  ...
  if (this.row < this.instance.getSettings().fixedRowsTop) {
    ...
    this.instance.getSettings().fixedRowsBottom &&
    this.row >= totalRows - this.instance.getSettings().fixedRowsBottom
  ) {
    if (this.col < this.instance.getSettings().fixedColumnsLeft) {
