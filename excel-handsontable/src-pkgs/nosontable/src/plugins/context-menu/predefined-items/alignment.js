      ...
      items: [
        {
          ...
          callback() {
            ...
            const stateBefore = getAlignmentClasses(
              selectedRange,
              (row, col) => this.getCellMeta(row, col).className,
            );
        ...
        },
        {
          ...
          name() {
            let label = this.getTranslatedPhrase(
              C.CONTEXTMENU_ITEMS_ALIGNMENT_RIGHT,
            );
            const hasClass = checkSelectionConsistency(
              this.getSelectedRange(),
              (row, col) => {
        ...
        },
        {
          ...
          name() {
            let label = this.getTranslatedPhrase(
              C.CONTEXTMENU_ITEMS_ALIGNMENT_TOP,
            );
            const hasClass = checkSelectionConsistency(
              this.getSelectedRange(),
              (row, col) => {
        ...
        },
        {
          ...
          name() {
            let label = this.getTranslatedPhrase(
              C.CONTEXTMENU_ITEMS_ALIGNMENT_MIDDLE,
            );
            const hasClass = checkSelectionConsistency(
              this.getSelectedRange(),
              (row, col) => {
        ...
        },
        {
          ...
          name() {
            let label = this.getTranslatedPhrase(
              C.CONTEXTMENU_ITEMS_ALIGNMENT_BOTTOM,
            );
            const hasClass = checkSelectionConsistency(
              this.getSelectedRange(),
              (row, col) => {
