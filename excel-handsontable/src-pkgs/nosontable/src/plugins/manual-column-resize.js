...
class ManualColumnResize extends BasePlugin {
  ...
  enablePlugin() {
    ...
    this.addHook(
      ...
      (currentColumn, newSize, isDoubleClick) =>
        this.onBeforeColumnResize(currentColumn, newSize, isDoubleClick),
    );
  ...
  setupGuidePosition() {
    ...
    const handleBottomPosition =
      parseInt(this.handle.style.top, 10) + handleHeight;
    const maximumVisibleElementHeight = parseInt(
      this.hot.view.maximumVisibleElementHeight(0),
      10,
    );
