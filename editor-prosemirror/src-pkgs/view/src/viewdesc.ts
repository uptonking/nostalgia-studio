...
class MarkViewDesc extends ViewDesc {
  ...
  static create(
    ...
    if (!spec || !spec.dom)
      spec = (DOMSerializer.renderSpec as any)(
        document,
...
export class NodeViewDesc extends ViewDesc {
  ...
  static create(
    ...
    if (node.isText) {
      ...
      let spec = (DOMSerializer.renderSpec as any)(
        document,
...
class ViewTreeUpdater {
  ...
  recreateWrapper(
    ...
    if (
      ...
      return null;
    let wrapper = NodeViewDesc.create(
      this.top,
      node,
      outerDeco,
      innerDeco,
