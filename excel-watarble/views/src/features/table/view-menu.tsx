...
export const ViewMenu = () => {
  ...
  return (
    <Button.Group>
      ...
      >
        ...
        <Menu.Dropdown w={300}>
                ...
                {displayTypes.map((d) => (
                  ...
                  >
                    <Group w='100%'>
                      ...
                      {d.value === view.displayType && (
                        <IconCheck color='gray' size={18} />
                      )}
                    </Group>
                  </Menu.Item>
                ))}
          ...
          <Menu.Item
            fz='xs'
            color='gray.9'
            icon={<IconPencil color='gray' size={16} />}
            onClick={toggleEditing.open}
          >
            {t('Update View Name')}
          </Menu.Item>
          <Menu.Item
      ...
      {displayType === 'kanban' ? (
        <KanbanControl kanban={view.kanban.into()} />
      ) : null}
      {displayType === 'calendar' ? (
        <CalendarControl calendar={view.calendar.into()} />
      ) : null}
      {displayType === 'tree' ? (
        <TreeControl tree={view.treeView.into()} />
      ) : null}
    </Button.Group>
  );
};
