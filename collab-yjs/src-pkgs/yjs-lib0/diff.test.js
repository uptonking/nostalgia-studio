...
export const testDiffing = (tc) => {
  ...
  runDiffTest(
    '\u{d83d}\u{dc77}' /* '👷' */,
    '\u{d83d}\u{dea7}\u{d83d}\u{dc77}' /* '🚧👷' */,
    { index: 0, remove: 0, insert: '🚧' },
  );
  runDiffTest(
    '\u{d83d}\u{dea7}\u{d83d}\u{dc77}' /* '🚧👷' */,
    '\u{d83d}\u{dc77}' /* '👷' */,
    { index: 0, remove: 2, insert: '' },
  );
  // These strings share low-surrogate characters
  runDiffTest(
    '\u{d83d}\u{dfe6}\u{d83d}\u{dfe6}' /* '🟦🟦' */,
    '\u{d83c}\u{dfe6}\u{d83d}\u{dfe6}' /* '🏦🟦' */,
    { index: 0, remove: 2, insert: '🏦' },
  );
...
export const testSimpleDiffWithCursor = (tc) => {
  ...
  }
  {
    ...
    const recomposedSecond = str.splice(
      initial,
      change.index,
      change.remove,
      change.insert,
