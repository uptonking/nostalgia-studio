...
export const StandardIrreducible64 = new Uint8Array([
  1, 133, 250, 114, 193, 250, 28, 193, 231,
]);
export const StandardIrreducible128 = new Uint8Array([
  1, 94, 109, 166, 228, 6, 222, 102, 239, 27, 128, 184, 13, 50, 112, 169, 199,
]);
 ...
 */
const ensureCache = (m) =>
  map.setIfUndefined(_precomputedFingerprintCache, buffer.toBase64(m), () => {
