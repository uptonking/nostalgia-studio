...
export const sign = (key, data) =>
  webcrypto.subtle
    .sign(defaultSignAlgorithm, key, data)
...
export const verify = (key, signature, data) =>
  webcrypto.subtle.verify(defaultSignAlgorithm, key, signature, data);
...
export const generateKeyPair = ({
  ...
  webcrypto.subtle.generateKey(defaultKeyAlgorithm, extractable, usages);
 ...
 * @param {Usages} [opts.usages]
 */
export const importKeyRaw = (
  raw,
  { extractable = false, usages = defaultUsages } = {},
) =>
