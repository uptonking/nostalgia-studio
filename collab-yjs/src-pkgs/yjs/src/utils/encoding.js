...
export const writeClientsStructs = (encoder, store, _sm) => {
  ...
  array
    ...
    .forEach(([client, clock]) => {
      writeStructs(
        encoder,
        /** @type {Array<GC|Item>} */ (store.clients.get(client)),
        client,
        clock,
      );
    });
...
const integrateStructs = (transaction, store, clientsStructRefs) => {
  ...
  let clientsStructRefsIds = array
    .from(clientsStructRefs.keys())
    .sort((a, b) => a - b);
 ...
 * @function
 */
export const writeStateAsUpdate = (
  encoder,
  doc,
  targetStateVector = new Map(),
) => {
 ...
 * @function
 */
export const encodeStateAsUpdateV2 = (
  doc,
 ...
 * @function
 */
export const decodeStateVector = (decodedState) =>
...
export const encodeStateVector = (doc) =>
  encodeStateVectorV2(doc, new DSEncoderV1());
