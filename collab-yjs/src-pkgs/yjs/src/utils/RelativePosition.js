 ...
 * @function
 */
export const createRelativePositionFromJSON = (json) =>
 ...
 * @function
 */
export const createAbsolutePosition = (type, index, assoc = 0) =>
 ...
 * @return {RelativePosition}
 */
export const decodeRelativePosition = (uint8Array) =>
 ...
 * @function
 */
export const compareRelativePositions = (a, b) =>
  a === b ||
  (a !== null &&
    b !== null &&
    a.tname === b.tname &&
