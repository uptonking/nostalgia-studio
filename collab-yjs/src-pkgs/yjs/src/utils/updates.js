 ...
 * @return {Uint8Array}
 */
export const encodeStateVectorFromUpdateV2 = (
  update,
 ...
 * @return {Uint8Array}
 */
export const encodeStateVectorFromUpdate = (update) =>
 ...
 * @return {{ from: Map<number,number>, to: Map<number,number> }}
 */
export const parseUpdateMeta = (update) =>
  parseUpdateMetaV2(update, UpdateDecoderV1);
 ...
 */
export const convertUpdateFormat = (
  update,
  blockTransformer,
  YDecoder,
  YEncoder,
      ...
      case Item: {
        ...
        switch (content.constructor) {
          ...
          case ContentType: {
            if (yxml) {
              ...
              if (type instanceof YXmlElement) {
                type.nodeName = map.setIfUndefined(
                  nodeNameCache,
                  type.nodeName,
                  () => 'node-' + i,
                );
              ...
              if (type instanceof YXmlHook) {
                type.hookName = map.setIfUndefined(
                  nodeNameCache,
                  type.hookName,
                  () => 'hook-' + i,
                );
          ...
          case ContentFormat: {
            ...
            if (formatting) {
              c.key = map.setIfUndefined(
                formattingKeyCache,
                c.key,
                () => i + '',
              );
              c.value = map.setIfUndefined(
        ...
        if (item.parentSub) {
          item.parentSub = map.setIfUndefined(
            mapKeyCache,
            item.parentSub,
            () => i + '',
          );
 ...
 */
export const obfuscateUpdate = (update, opts) =>
  convertUpdateFormat(
    update,
 ...
 * @param {ObfuscatorOptions} [opts]
 */
export const obfuscateUpdateV2 = (update, opts) =>
  convertUpdateFormat(
    update,
    createObfuscator(opts),
    UpdateDecoderV2,
 ...
 * @param {Uint8Array} update
 */
export const convertUpdateFormatV1ToV2 = (update) =>
  convertUpdateFormat(update, f.id, UpdateDecoderV1, UpdateEncoderV2);

/**
 * @param {Uint8Array} update
 */
export const convertUpdateFormatV2ToV1 = (update) =>
  convertUpdateFormat(update, f.id, UpdateDecoderV2, UpdateEncoderV1);
