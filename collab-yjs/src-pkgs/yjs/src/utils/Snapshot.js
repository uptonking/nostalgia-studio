 ...
 * @return {Doc}
 */
export const createDocFromSnapshot = (
  originDoc,
  snapshot,
  newDoc = new Doc(),
) => {
 ...
 */
export const snapshotContainsUpdateV2 = (
  snapshot,
  update,
 ...
 * @param {Uint8Array} update
 */
export const snapshotContainsUpdate = (snapshot, update) =>
  snapshotContainsUpdateV2(snapshot, update, UpdateDecoderV1);
