  ...
  return (
    ...
    (_plugin = ViewPlugin.fromClass(
      class {
        ...
        makeDecorator(
          conf: Required<SpecialCharConfig> & { replaceTabs?: boolean },
        ) {
          return new MatchDecorator({
            ...
            decoration: (m, view, pos) => {
              ...
              if (code == 9) {
                ...
                let col = countColumn(line.text, size, pos - line.from);
...
class SpecialCharWidget extends WidgetType {
  constructor(
    readonly options: Required<SpecialCharConfig>,
    readonly code: number,
  ) {
    super();
  }

  eq(other: SpecialCharWidget) {
