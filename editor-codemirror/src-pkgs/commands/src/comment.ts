...
function command(
  f: (option: CommentOption, state: EditorState) => TransactionSpec | null,
...
export const toggleLineComment = command(
  changeLineComment,
...
export const lineUncomment = command(
  changeLineComment,
...
/// [`commentTokens`](#commands.CommentTokens) [language
/// data](#state.EditorState.languageDataAt).
export const toggleBlockComment = command(
  changeBlockComment,
  CommentOption.Toggle,
);
...
export const blockUncomment = command(
  changeBlockComment,
  CommentOption.Uncomment,
);
...
/// block comments.
export const toggleBlockCommentByLine = command(
