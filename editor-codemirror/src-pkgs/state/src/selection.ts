...
export class SelectionRange {
  ...
  get assoc(): -1 | 0 | 1 {
    return this.flags & RangeFlag.AssocBefore
      ? -1
      : this.flags & RangeFlag.AssocAfter
        ? 1
        : 0;
  }
...
export class EditorSelection {
  ...
  static fromJSON(json: any): EditorSelection {
    ...
    return new EditorSelection(
      json.ranges.map((r: any) => SelectionRange.fromJSON(r)),
      json.main,
    );
  }
  ...
  static range(
    ...
    return head < anchor
      ? SelectionRange.create(
          head,
          anchor,
          RangeFlag.Inverted | RangeFlag.AssocAfter | flags,
        )
      : SelectionRange.create(
          anchor,
          head,
